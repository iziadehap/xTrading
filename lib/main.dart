...
import 'package:x_trading_flutter/config.dart';
...
void main() async {
  ...
  final apiUrl = dotenv.get('BaseUrl');
  Config.initializeFromEnv(apiUrl);

  // Initialize settings service (will cache the default URL if not already cached)
